...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".navbar-collapse">
			...
			<div class="row">
				...
				<form class="marginTop" method="post">
					...
					<div class="form-group">
						...
						<input type="password" name="password" class="form-control" placeholder="Password" value="<? echo addslashes($_POST['email']); ?>"/>
	...
	<script>
		...
		$(".middleContainer").css("min-height",$(window).height()-300);
